...
class Task4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          MyWidget(color: Colors.black, text: '', textColor: Colors.black),
          Expanded(
            flex: 3,
            child: Container(
              color: Colors.black,
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Text(
                                    '<main>',
                                    style: TextStyle(
                                      color: Color.fromARGB(255, 204, 123, 96),
                                    ),
                                  ),
                                ),
                                Expanded(
                                  ...
                                  child: Container(
                                    margin: EdgeInsetsGeometry.all(15),
                                    color: Color.fromARGB(255, 80, 132, 162),
                                    child: Column(
                                ...
                                MyWidget(
                                  color: Color.fromARGB(255, 80, 132, 162),
                                  text: '<article>',
                                  textColor: Color.fromARGB(255, 238, 242, 245),
                                ),
                              ],
                            ),
                          ),
